...
$(document).ready(function () {
    ...
    $('#dockMenuHome').click(function () {
        renderMenuHome(null, true);
    });
    $('#dockMenuAboutUs').click(function () {
        renderMenuAboutUs(null, true);
    });
});
...
/* Only used in project plugin to format backlog idea */
function formatIdea(actor, purpose, benefit) {
