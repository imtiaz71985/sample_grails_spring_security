...
<!-- Timeline CSS -->
<link rel="stylesheet" href="${resource(dir: 'dist', file: 'css/timeline.css')}">

<!-- Custom CSS -->
<link rel="stylesheet" href="${resource(dir: 'dist', file: 'css/sb-admin-2.css')}">

<!-- Metis Menu Plugin JavaScript -->
<script rel="stylesheet" src="${resource(dir: 'components', file: 'metisMenu/dist/metisMenu.min.js')}"></script>
