...
class ListSecUserActionServiceModel {
    ...
    DROP VIEW IF EXISTS list_sec_user_action_service_model;
    CREATE OR REPLACE VIEW list_sec_user_action_service_model AS
        SELECT id, version,username,password, enabled, account_expired, account_locked, password FROM sec_user;
    """
